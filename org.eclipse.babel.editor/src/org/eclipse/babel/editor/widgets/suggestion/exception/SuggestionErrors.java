...
public class SuggestionErrors{
	...
	/**
	 * to be used, in case suggestion provider doesn't support a specific language
	 */
	...
	/** 
	 * Checks whether a string is contained in this class, i.e
	 * whether the string is an error message.
	 * 
